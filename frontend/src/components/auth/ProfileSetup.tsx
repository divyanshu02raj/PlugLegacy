      ...
      {!isExiting ? (
        <AuthLayout key="setup">
            ...
            {avatars.map((avatar, index) => {
              ...
              return (
                <motion.button
                  ...
                  className={`relative aspect-square rounded-2xl flex flex-col items-center justify-center gap-2 transition-all duration-300 overflow-hidden group ${
                    isSelected
                      ? "bg-glass-hover"
                ...
                >
                  ...
                  <motion.div
                    className={`relative transition-all duration-300 ${
                      isSelected ? "" : "grayscale opacity-50 group-hover:grayscale-0 group-hover:opacity-100"
                    }`}
          ...
          <motion.button
            ...
            className={`w-full py-4 rounded-xl font-bold text-base flex items-center justify-center gap-3 transition-all duration-300 group ${
              selectedAvatar
