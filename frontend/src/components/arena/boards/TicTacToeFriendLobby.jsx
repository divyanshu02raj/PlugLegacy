...
const TicTacToeFriendLobby = ({ onBack }) => {
    ...
    useEffect(() => {
        ...
        // Fail-safe logic: Listen for game_start here too (inviter side)
        const handleGameStart = (data) => {
            const { roomId, players } = data;
            console.log("FriendLobby received game_start:", roomId);
            // Navigate to current route with state (replaces current view with game board)
            navigate(".", {
                state: {
                    roomId,
                    players,
    ...
    const handleInvite = (friend) => {
        ...
        socket.emit('send_game_invite', {
            ...
            fromUsername: 'Friend' // Username is handled by server or context usually
        });
        ...
        <div className="flex flex-col items-center w-full max-w-[600px] gap-6 animate-in fade-in zoom-in duration-500">
            ...
            <div className="w-full flex items-center justify-between">
                ...
                <div className="text-center flex-1 pr-9">
                    <h2 className="text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-primary to-cyan-500">
                        Play with Friend
                    </h2>
                                ...
                                return (
                                    ...
                                    >
                                        <div className="flex items-center gap-3">
                                            <div className="w-10 h-10 rounded-full bg-gradient-to-br from-cyan-500 to-blue-500 flex items-center justify-center font-bold text-white shadow-lg">
                                        ...
                                        <button
                                            ...
                                            ${(!isOnline || invitedUsers.has(friend._id))
                                                    ...
                                                    : "bg-cyan-500 text-white hover:bg-cyan-600 hover:shadow-[0_0_15px_rgba(6,182,212,0.4)]"
                                                }
                                        `}
                                        >
